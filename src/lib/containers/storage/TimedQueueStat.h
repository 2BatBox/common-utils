#ifndef STORAGE_TIMEQUEUESTAT_H
#define STORAGE_TIMEQUEUESTAT_H
...
struct TimedQueueStat {
	...
	void print(FILE* out, const TimedQueueStat&) const noexcept {
