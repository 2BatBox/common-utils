...
#include "TestRingArrayBuffer.h"
#include "TestFio.h"

#include "TestIntrusiveLinkedList.h"
...
//	TestRinArrayBuffer<capacity> test_sliding_array;
//	TestIntrusiveLinkedList test_list(capacity);
